...
final bool? isRemove;
  ...
  factory ProductApiModel2.fromJson(String str) => ProductApiModel2.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory ProductApiModel2.fromMap(Map<String, dynamic> json) => ProductApiModel2(
    itemCode: json["ItemCode"],
    itemName: json["ItemName"],
    uPacking: json["U_PACKING"],
    invntryUom: json["InvntryUom"],
