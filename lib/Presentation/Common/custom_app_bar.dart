...
class CustomAppBarState extends State<CustomAppBar> {
  ...
  Widget build(BuildContext context) {
    return AppBar(
      ...
      centerTitle: true,
      leading: widget.isSplashScreen != null
          ? SizedBox(
              height: 0.sp,
              width: 0.sp,
            )
          : widget.isNotificationScreen != null
              ? SizedBox(
                  height: 0.sp,
                  width: 0.sp,
                )
                    ...
                    children: <Widget>[
                      ValueListenableBuilder(
                        builder: (context, state, child) {
                          return Row(
                            children: <Widget>[
                              widget.isShowNotificationButton != null ||
                                      state > 0
                                  ? const SizedBox(
                                      height: 0,
                                      width: 0,
                                  ...
                                  : BlocBuilder<NotificationCubit,
                                      ...
                                      builder: (context, state) {
                                        if (state is NotificationLoaded) {
                                          int readCount = state.notifications
                                              .where(
                                                  (data) => data.pstatus == '0')
                                              .length;
                        ...
                        valueListenable:
                            BottomNotifier.bottomNavigationNotifier,
                      ),
                      SizedBox(
                        width: 20.sp,
                      ),
