                  ...
                  Expanded(
                    child: ListView.separated(
                        itemBuilder: (context, index) {
                          final timings = state
                              .contactUsData.branches![index].timing
                              .toString();
                          ...
                          String apiEmail = state
                              .contactUsData.branches![index].email
                              .toString()
                              .trim();

                          String newEmail = apiEmail.replaceAll(
                              "al-imdad.com", "hbkblankets.com");
                          return ExpandableTileWidget(
                            ...
                            expendedContent: ExpandableContents(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            CustomButton(
                                              ...
                                              gapWidth: 10.sp,
                                              text: state.contactUsData
                                                  .branches![index].mobile
                                                  .toString()
                                                  .trim(),
                                              horizontalMargin: 20.w,
                                              leadingIcon: Assets.calling,
                              ...
                              button1Text: 'Call',
                              location: state
                                  .contactUsData.branches![index].address
                                  .toString()
                                  .trim(),
