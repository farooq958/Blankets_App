  ...
  void initState() {
    ...
    Future.wait([
      context
          ...
          .updateData(SharedPrefs.getUsername(), SharedPrefs.getPassword())
    ]);
                      ...
                      child: ListView.separated(
                          ...
                          itemBuilder: (context, index) {
                            return CustomInfoWidget(
                              nameInfo:
                                  Utils.customInfoData[index].amount.toString(),
                              nameInfoValue:
                    ...
                    SingleChildScrollView(
                      ...
                      child: SizedBox(
                        ...
                        child: Wrap(
                          ...
                          children: List.generate(uState.customCardData.length,
                              (index) {
                            print("shareddatacheck");
                            print(SharedPrefs.userData!.ordersBal.toString());
                            return SizedBox(
                              width: (1.sw / 1 - 10.sp) / 3,
                              // Adjust width to fit three items
                              child: CustomCard(
                                name: uState.customCardData[index].name
                                    .toString(),
                                amount: uState.customCardData[index].amount
                                    .toString(),
                              ),
                            );
                          }),
                            ...
                            child: SizedBox(
                              ...
                              child: Wrap(
                                ...
                                children: List.generate(
                                    state.bottomCardData1.length, (index) {
                                  return SizedBox(
                                    width: (1.sw - 5.sp) / 2,
                                    // Adjust width to fit two items
                                    child: BottomCards(
                                      imageAsset:
                                          state.bottomCardData1[index].icon!,
                                      mainStatus:
                                          state.bottomCardData1[index].title!,
                                      statusValue:
                                          state.bottomCardData1[index].status!,
                                    ),
                                  );
                                }),
                              ),
