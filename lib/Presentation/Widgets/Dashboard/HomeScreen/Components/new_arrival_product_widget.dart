          ...
          children: [
            ...
            GestureDetector(
                ...
                child: widget.isFromApi == true
                    ? CachedImage(
                        url:
                            "http://imtxt.sbsolutions.com.pk:44891/Picture/CustomerApplogin/${widget.productData!.uImage.toString()}",
                        isCircle: false,
                        width: 110,
                        height: 100.h,
                      )
                    : AssetImageWidget(
                        url: widget.dummyProduct!.productImage.toString(),
                        radius: 40.sp,
                        width: 110.w,
                        height: 100.h,
                      )),
            ...
            GestureDetector(
              ...
              child: Padding(
                ...
                child: widget.isFromApi == true
                    ...
                    : AppText(
                        widget.dummyProduct!.productDescription.toString(),
                        maxLine: 3,
                        style: Styles.circularStdBold(context,
                            fontWeight: FontWeight.w500)),
              ),
                ...
                : Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        widget.isFromApi == true
                            ? AppText(
                                "${widget.productData!.price?.replaceAll(RegExp(r'\.0+$'), '')}",
                                maxLine: 1,
                                style: Styles.circularStdBold(context,
                                    fontWeight: FontWeight.w500,
