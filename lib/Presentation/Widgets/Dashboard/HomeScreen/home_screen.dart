...
import 'SliderImages/Controller/slider_images_cubit.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    context
        ...
        .getNewArrivalProducts(isGuest: widget.isGuest);
        ...
        child: SingleChildScrollView(
          child: BlocBuilder<CartCubit, CartState>(
            builder: (context, cartState) {
              return BlocBuilder<NewArrivalProductCubit,
                  NewArrivalProductState>(
                                  ...
                                  RichText(
                                    ...
                                    TextSpan(
                                        ...
                                        style: Styles.circularStdBold(context,
                                            fontSize: 16.sp)),
                                    TextSpan(
                                        text: SharedPrefs.userData!.balance
                                            .toString(),
                                        style: Styles.circularStdBold(context,
                        ...
                        SizedBox(
                            ...
                            child: BlocBuilder<CartCubit, CartState>(
                              builder: (context, cartState) {
                                print(cartState);
                                print('cubit rebuild');
                                return BlocConsumer<NewArrivalProductCubit,
                                    NewArrivalProductState>(
                                      ...
                                      return ListView.separated(
                                        ...
                                        itemBuilder: (context, index) {
                                          Future<bool> getBoolValueForCart(
                                              String itemCode,
                                              List<ProductApiModel> pr) async {
                                            bool stat = await CartDatabase
                                                .cartDatabaseInstance
                                                .isProductInCart(itemCode);
                                            print(
                                                "here in function + value = $stat");
                                          ...
                                          if (state
                                              is NewArrivalProductLoaded) {
                                            var isRemove = getBoolValueForCart(
                                                loadedData[index]
                                                    .itemCode
                                                    .toString(),
                                                loadedData);
...
//Future.delayed(const Duration(seconds: 1));
                                                    ...
                                                    child: NewArrivalProduct(
                                                        ...
                                                        dummyProduct:
                                                            Utils.dummyProduct[
                                                                index],
                                                        isGuest:
                                                            true), // Create a ShimmerListTile widget
                                                  ),
                                                )
                                              : NewArrivalProduct(
                                                  isFromApi: true,
                                                    ...
                                                    Navigate.to(
                                                        ...
                                                        ProductDetails(
                                                          ...
                                                          productDto:
                                                              loadedData[index],
                                                          isApi: true,
                                                          isRemove: mapIsRemove[
                                                              index],
                                                        ));
                                                  },
                                                  isGuest: widget.isGuest,
                                                  onAddToCardTap: () async {
                                                    if (widget.isGuest ==
                                                        true) {
                                                      CustomDialog.dialog(
                                                          context,
                                                      ...
                                                      // print('intap');
                                                      //  print( isRemove);
                                                      if (mapIsRemove[index] ==
                                                          false) {
                                                        int cartStatus = await CartDatabase
                                                            .cartDatabaseInstance
                                                            .deleteCart(
                                                                loadedData[
                                                                        index]
                                        ...
                                        itemCount: state
                                                    is NewArrivalIndividualLoading ||
                                                state
                                                    is NewArrivalProductLoading
                                            ? Utils.dummyProduct.length
                                            : loadedData.length,
                                      );
                                    }
                                    // if(state is NewArrivalProductLoaded  ) {
