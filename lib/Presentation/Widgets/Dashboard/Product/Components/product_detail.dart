                    ...
                    children: <Widget>[
                      ...
                      Center(
                          child: widget.isApi == true
                              ? CachedImage(
                                  url:
                                      "http://imtxt.sbsolutions.com.pk:44891/Picture/${widget.productDto!.uImage}",
                                  width: 270.w,
                                  height: 220.sp,
                                  isCircle: false)
                              : AssetImageWidget(
                          ...
                          child: ListTile(
                            ...
                            leading: Column(
                              children: [
                                ...
                                Expanded(
                                    child: AppText(
                                        'Rs ${double.parse(widget.productDto!.price.toString()) * double.parse(widget.productDto!.defaultSalesUom.toString().split(' ').first)}',
                                        style: Styles.circularStdBold(context,
                                ...
                                child: CustomButton(
                                  onTap: () async {
                                    ...
                                    if (isRemove == true) {
                                      CartModel cm = CartModel(
                                          ...
                                          productQuantity: QuantityNotifier
                                              ...
                                              .toString(),
                                          productPrice: widget.productDto!.price
                                              .toString(),
                                          productImage: widget
                                              .productDto!.uImage
                                              .toString(),
                                    ...
                                    context
                                        ...
                                        .getNewArrivalProducts(notReload: true);
                                  },
                                  textFontWeight: FontWeight.normal,
                                  textSize: 16,
                                  borderRadius: 40,
