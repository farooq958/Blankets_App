...
print('stateeeeee');
              ...
              CustomSizedBox.height(10),
                 ProductTile(tileColor: AppColors.productTileColor,leadingName: 'Product origin',trailingName:  widget.isApi==true?getOriginString(widget.productDto!):'China',),
                 ProductTile(tileColor: AppColors.whiteColor,leadingName: 'Category',trailingName: widget.isApi==true?widget.productDto!.cat.toString():'1 PLY Double bet blanket',),
                 ProductTile(tileColor: AppColors.productTileColor,leadingName: 'Product brand',trailingName:  widget.isApi==true?widget.productDto!.itemName.toString().split(" ").first:'Burjjan',),
                 ProductTile(tileColor: AppColors.whiteColor,leadingName: 'Product packaging',trailingName: widget.isApi==true?widget.productDto!.uPacking:'Play bag',),
                 ProductTile(tileColor: AppColors.productTileColor,leadingName: 'Specification',trailingName: widget.isApi==true?widget.productDto!.uGoodstype:'200 x 240 CMS',),
                 ProductTile(tileColor: AppColors.whiteColor,leadingName: 'Embossed',trailingName:   widget.isApi==true?getEmbossedString(widget.productDto!) :'Yes',),
                ProductTile(tileColor: AppColors.productTileColor,leadingName: 'Pcs Per Carton',trailingName:   widget.isApi==true?widget.productDto!.defaultSalesUom.toString() :'20 Pcs',),
