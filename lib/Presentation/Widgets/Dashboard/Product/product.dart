...
// TODO: implement listener
          ...
          builder: (context, state) {
            ...
            Future<bool> getBoolValueForCart(
                String itemCode, List<ProductApiModel> pr) async {
              //    print("here in function + value = $stat");
              List<ProductApiModel2> p2 = [];
              for (int i = 0; i < tempSearchData.length; i++) {
                bool stat = await CartDatabase.cartDatabaseInstance
                    .isProductInCart(tempSearchData[i].itemCode.toString());
            ...
            if (state is AllProductsLoaded) {
              var isRemove = getBoolValueForCart(
                  'tempSearchData[i].itemCode.toString()', tempSearchData);
            }
                ...
                return Column(
                  children: [
                    ...
                    widget.isGuest == true
                        ...
                        : SortAndFilter(
                            onFilterTap: () async {
                              List<String> categoryDto = getCategoryData(
                    ...
                    Align(
                        alignment: Alignment.centerLeft,
                        child: AppText(
                            "${tempSearchData.length} Products Found",
                                    ...
                                    NewArrivalProduct(
                                        ...
                                        if (widget.isGuest == true) {
                                          ...
                                          if (mapIsRemove[i] == false) {
                                            ...
                                            CartModel cm = CartModel(
                                                productId: tempSearchData[i]
                                                    .itemCode
                                                    .toString(),
                                                productName: tempSearchData[i]
                                                    .itemName
                                                    .toString(),
                                                productQuantity: '1',
                                                productPrice: tempSearchData[i]
                                                    .price
                                                    .toString(),
                                                productImage: tempSearchData[i]
                                                    .uImage
                                                    .toString(),
                                                multiplier: tempSearchData[i]
                                                    .multiplier
                                                    .toString(),
                                                pcsCtn: tempSearchData[i]
                                                    .defaultSalesUom
                                                    .toString());
                                            var cartStatus = await CartDatabase
                                                .cartDatabaseInstance
                                      ...
                                      onDetailTap: () {
                                        Navigate.to(
                                            context,
                                            ProductDetails(
                                              productDto: tempSearchData[i],
                                              isGuest: widget.isGuest,
                                              isApi: true,
                                              isRemove: mapIsRemove[i],
                                              catId: widget.catId,
                                            ));
                                      },
                                      isGuest: widget.isGuest,
